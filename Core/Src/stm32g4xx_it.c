...
//	HAL_GPIO_TogglePin(SYNC2_GPIO_Port, SYNC2_Pin);
  /* USER CODE END TIM7_DAC_IRQn 0 */
  HAL_TIM_IRQHandler(&htim7);
  /* USER CODE BEGIN TIM7_DAC_IRQn 1 */
//  HAL_GPIO_WritePin(U_DB0_GPIO_Port, U_DB0_Pin,GPIO_PIN_SET);
  TIM7_Execution();
//  HAL_GPIO_WritePin(U_DB0_GPIO_Port, U_DB0_Pin,GPIO_PIN_RESET);
